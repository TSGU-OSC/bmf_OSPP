...
class TestVideoCModule(BaseTestCase):
    ...
    def test_video(self):
        ...
        # c module processing
        video_1 = (video['video'].c_module("cpp_copy_module","./libcopy_module.so","copy_module::CopyModule"))
        video_2 = (video['video'].c_module("cpp_copy_module","./libcopy_module.so","copy_module::CopyModule"))
        video_3 = (video['video'].c_module("cpp_copy_module","./libcopy_module.so","copy_module::CopyModule"))
